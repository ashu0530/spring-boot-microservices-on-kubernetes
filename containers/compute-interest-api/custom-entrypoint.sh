...
then
    echo "Environment variables not found. Using default credentials (user ashu, password password, host account-database, port 3306) instead if it has been setup."
else
